  ...
  if (!user) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-black text-gray-900 dark:text-gray-100">
        ...
        <button
          onClick={login}
          className="px-6 py-3 rounded-md bg-gray-900 text-white hover:opacity-90 transition dark:bg-gray-100 dark:text-black"
        >
          Login with GitHub
        </button>
      </main>
    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-black text-gray-900 dark:text-gray-100 space-y-6">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <a
          ...
          className="px-6 py-2 rounded-md bg-gray-900 text-white hover:opacity-90 dark:bg-gray-100 dark:text-black transition"
        >
          Go to Shopping List
        </a>
      </div>
